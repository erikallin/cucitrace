  ...
  public j c(g paramg, int paramInt)
  {
    if (!paramg.U())
    {
      if (e(paramg))
      {
        ...
        paramg.r(paramInt);
        this.i = new j(230, "employee card account is successfully withdrawn from");
      ...
      {
        this.i = new j(220, "employee card account balance is too low to be withdrawn from");
      }
      

    }
    else {
      this.i = new j(240, "employee card account is not withdrawn from");
    }
