  ...
  extends r
{
  ...
  private Map<a.c.c.b, String> cq;
  private Map<a.c.c.e, String> cr;
  private b cs;
  private b ct;
  ...
  u(int paramInt1, int paramInt2, v paramv, Rectangle2D paramRectangle2D, boolean paramBoolean)
  {
    ...
    a.c.c.a.a(paramRectangle2D, "bounds");
    this.cl = paramv;
  ...
  {
    a.c.c.b localb = new a.c.c.b(paramGradientPaint);
    ...
    if (str == null) {
      ...
      a.c.b.a locala = new a.c.b.a(localk.aL(), arrayOfDouble, locald);
      localk.a(locala);
  ...
  {
    a.c.c.e locale = new a.c.c.e(paramRadialGradientPaint);
    ...
    if (str == null) {
      ...
      a.c.b.b localb = new a.c.b.b(localk.aL(), arrayOfDouble, localg);
      localk.a(localb);
  ...
  {
    a.c.c.a.a(paramImage, "img");
    k localk = this.cl.bu();
    s locals = new s(
      localk.aL(), paramImage);
    locals.a(new a.c.a.e());
    localk.a(locals);
