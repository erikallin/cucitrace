...
{
  public static Rectangle2D a(String paramString, Graphics2D paramGraphics2D, float paramFloat1, float paramFloat2, TextAnchor paramf)
  {
  ...
  private static float[] a(Graphics2D paramGraphics2D, String paramString, TextAnchor paramf)
  {
  ...
  private static float[] a(Graphics2D paramGraphics2D, String paramString, TextAnchor paramf, Rectangle2D paramRectangle2D)
  {
  ...
  public static void a(String paramString, Graphics2D paramGraphics2D, float paramFloat1, float paramFloat2, TextAnchor paramf, double paramDouble, float paramFloat3, float paramFloat4)
  {
  ...
  public static void a(String paramString, Graphics2D paramGraphics2D, float paramFloat1, float paramFloat2, TextAnchor paramf1, double paramDouble, TextAnchor paramf2)
  {
    if ((paramString == null) || (paramString.equals(""))) {
      return;
    }
  ...
  private static float[] b(Graphics2D paramGraphics2D, String paramString, TextAnchor paramf)
  {
    float[] arrayOfFloat = new float[2];
    FontRenderContext localFontRenderContext = paramGraphics2D.getFontRenderContext();
