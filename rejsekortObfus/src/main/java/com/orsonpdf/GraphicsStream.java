  ...
  extends Stream
{
  ...
  GraphicsStream(int paramInt, Page paramu)
  {
    super(paramInt);
    this.ab = paramu;
  ...
  private void w(String paramString) {
    try {
      this.ac.write(PDFUtils.z(paramString));
  ...
  void e(Stroke paramStroke)
  {
    ...
    if (arrayOfFloat != null) {
      localStringBuilder.append(PDFUtils.c(arrayOfFloat)).append(" 0 d\n");
    } else {
