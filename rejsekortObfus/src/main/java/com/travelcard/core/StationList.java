...
public class StationList
{
  ...
  public StationList()
  {
    this.de = new ArrayList<Station>();
    RandomStations locala = new RandomStations();
    this.de = locala.x(10);
  }
  ...
  public void b(List<Station> paramList)
  {
    this.de = paramList;
  }
